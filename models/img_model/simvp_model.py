...
class Decoder(nn.Module):
    ...
    def forward(self, hid, enc1=None, inference=False):
...
class SimVP_Model(nn.Module):
    ...
    def forward(self, x_raw, inference=False):
        ...
        Y = self.dec(hid, skip,inference=inference)
        if inference is True:
            return Y
...
# model = SimVP_Model((6,3,64,64), N_S=4,N_T=8, model_type='gSTA', hid_S=64, hid_T=256)
